 ...
 */
@Data
public class ComponentConfigDTO extends BaseDTO implements Serializable {

    public static final String KEY_ID="ITS:FORM:COMT_CFG_B:COMT_ID";

    /*** 序列化ID*/
    private static final long serialVersionUID = -8759497501296199749L;
    ...
    @NotBlank(message = "组件字段名称[comtFldName]不能为空")
    private String comtFldName;

    /*** 组件字段代码*/
    @ApiModelProperty("组件字段代码")
    @NotBlank(message = "组件字段代码[comtFldCode]不能为空")
    ...
    @NotBlank(message = "组件类型[comtType]不能为空")
