...
@Data
public class FieldConfigDTO extends BaseDTO implements Serializable {

    public static final String KEY_ID="ITS:FORM:FLD_CFG_B:FLD_ID";
    /*** 序列化ID*/
    private static final long serialVersionUID = 6671564502654416034L;
