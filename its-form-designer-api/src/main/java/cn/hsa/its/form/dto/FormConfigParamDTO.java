 ...
 */
@Data
public class FormConfigParamDTO extends BaseDTO implements Serializable {

	private static final long serialVersionUID = -7624347391018468443L;
	/*** 表单ID*/
